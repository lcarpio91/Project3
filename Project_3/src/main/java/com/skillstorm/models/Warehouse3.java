...
public class Warehouse3 {
	...
	public Warehouse3(int productId, String productName, double productPrice, int quantity) {
		super();
	...
	public String toString() {
		return "Warehouse3 [productId=" + this.productId + ", productName=" + this.productName + ", productPrice=" + this.productPrice
